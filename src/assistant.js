...
async function askAssistant({ question, displayName = '使用者', recentMessages = [], notes = [] }) {
  const systemPrompt =
    ...
    '【回覆原則】\n' +
    '- 專業犀利、條理清晰、直擊核心，不說廢話或空話，給出具體數字、工法或法規條款依據。\n' +
    '- 輸出繁體中文 JSON 格式：\n' +
    '{\n' +
    '  "category": "領域標籤 (例如: 📜 都更危老法規 / 🏗️ 營造結構工法 / 🏛️ 建築空間設計 / 🌿 綠建ESG淨零 / 💰 造價與成本管控 / 📝 記事檢索答覆)",\n' +
    '  "conclusion": "核心結論與直接解答 (60字以內)",\n' +
    '  "details": ["關鍵要點或法規/技術解析1", "關鍵要點或法規/技術解析2", "關鍵要點或法規/技術解析3"],\n' +
    '  "risks": "實務潛在風險與避坑注意點 (50字以內)",\n' +
    '  "nextStep": "專家建議之後續具體行動或評估方案 (50字以內)"\n' +
    '}\n' +
    '請只輸出純 JSON 格式字串，不要加 markdown 標記。';
